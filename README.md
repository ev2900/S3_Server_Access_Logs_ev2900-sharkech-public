...
To better understand the usage of the repositories I create, I can look at the number of times the YAML file corresponding to a CloudFormation stack is accessed. This is a measurement of how many times a CloudFormation stack may have been deployed
